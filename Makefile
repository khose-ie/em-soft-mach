...
MCU_DEFS += $(if $(CONFIG_CPU_SERIES_STM32F1), $(if $(CONFIG_CPU_MODEL_STM32F100XB),  -DSTM32F100xB) \
            ...
            $(if $(CONFIG_CPU_SERIES_STM32F4), $(if $(CONFIG_CPU_MODEL_STM32F401XC),  -DSTM32F401xC) \
            ...
            $(if $(CONFIG_CPU_SERIES_STM32F7), $(if $(CONFIG_CPU_MODEL_STM32F722XX),  -DSTM32F722xx) \
            ...
            $(if $(CONFIG_CPU_SERIES_STM32H5), $(if $(CONFIG_CPU_MODEL_STM32H503XX),  -DSTM32H503xx) \
            ...
            $(if $(CONFIG_CPU_SERIES_STM32H7), $(if $(CONFIG_CPU_MODEL_STM32H723XX),  -DSTM32H723xx) \
